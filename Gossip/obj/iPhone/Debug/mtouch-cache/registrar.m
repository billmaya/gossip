...
native_to_managed_trampoline_Gossip_UpArrowButtonView_TouchesBegan (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_56, 1));
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_Gossip_UpArrowButtonView_TouchesEnded (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_57, 1));
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_Gossip_HardButtonView_TouchesEnded (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_60, 1));
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_Gossip_EasyButtonView_TouchesEnded (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_66, 1));
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_Gossip_RightArrowHelpView_TouchesBegan (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_82, 1));
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_Gossip_RightArrowHelpView_TouchesEnded (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_83, 1));
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_Gossip_LeftArrowHelpView_TouchesBegan (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_86, 1));
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_Gossip_LeftArrowHelpView_TouchesEnded (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_87, 1));
		}
		arg_ptrs [1] = mobj1;
...
void *
native_to_managed_trampoline_Gossip_StoreButtonView__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_Gossip_StoreButtonView_Draw (id this, SEL sel, CGRect p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_Gossip_StoreButtonView_TouchesBegan (id this, SEL sel, id p0, id p1)
{
	void *arg_ptrs [2];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_90, 1));
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_Gossip_RightArrowOptionsView_TouchesBegan (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_101, 1));
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_Gossip_RightArrowOptionsView_TouchesEnded (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_102, 1));
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_Gossip_MaxView__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_105));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_Gossip_OwenView_TouchesEnded (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_108, 1));
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_Gossip_LeftArrowTipsView_TouchesEnded (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr (nsobj0, false, monotouch_get_parameter_type (method_114, 0));
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_114, 1));
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_Gossip_ZoeView_TouchesEnded (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_118, 1));
		}
		arg_ptrs [1] = mobj1;
...
static MTClassMap __monotouch_class_map [] = {
	...
	{"StoreButtonView", "Gossip.StoreButtonView, Gossip", 0},
...
static MTClass __monotouch_classes [] = {
	...
	{"StoreButtonView", "ButtonView", 1, 3, 0},
...
static MTMethod __monotouch_methods [] = {
	...
	{"init","@@:",0, &native_to_managed_trampoline_Gossip_StoreButtonView__ctor},
	{"drawRect:","v@:{RectangleF=ffff}",0, &native_to_managed_trampoline_Gossip_StoreButtonView_Draw},
	{"touchesBegan:withEvent:","v@:@@",0, &native_to_managed_trampoline_Gossip_StoreButtonView_TouchesBegan},
